...
struct attm_desc_128 custs1_att_db[CUST1_IDX_NB] =
{
    ...
    // ADXL X Value Characteristic Declaration
    ...
    // ADXL X Value Characteristic Value
    ...
    // ADXL X Value Client Characteristic Configuration Descriptor
    [CUST1_IDX_ADXL_VAL_NTF_CFG]       = {(uint8_t*)&att_decl_cfg, ATT_UUID_16_LEN, PERM(RD, ENABLE) | PERM(WR, ENABLE),
                                            sizeof(uint16_t), 0, NULL},

    // ADXL X Value Characteristic User Description
