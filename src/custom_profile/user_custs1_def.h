...
#define DEF_CUST1_ADXL_VAL_CHAR_LEN        20
#define DEF_CUST1_ECG_VAL_CHAR_LEN         20
#define DEF_CUST1_VOL_VAL_CHAR_LEN         20
...
enum
{
    ...
    CUST1_IDX_ADXL_VAL_CHAR,
    CUST1_IDX_ADXL_VAL_VAL,
    CUST1_IDX_ADXL_VAL_NTF_CFG, 
    CUST1_IDX_ADXL_VAL_USER_DESC,
	
	  CUST1_IDX_ECG_VAL_CHAR,
    CUST1_IDX_ECG_VAL_VAL,
